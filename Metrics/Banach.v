...
Section Banach.
  ...
  Proof.
    ...
    intros ε.
    destruct (CR_rate_indicator (CN_ContrRate f) ε (existT _ _ (ML_appr_top L))) as [N H2].
    exists N.
    intros n H3.
  ...
  Proof.
    ...
    destruct (ML_bottom_dichotomy L) as [dicht|dicht].
    {
      ...
      destruct (CR_rate_indicator (ρ f)%metric (existT _ _ Hd1) (existT _ _ (ML_appr_top L))) as [n H4].
